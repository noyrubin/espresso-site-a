---
title: "Greek Frappé Recipe: Authentic Foamy Iced Coffee in 90 Seconds"
date: 2026-04-28
description: "Learn how to make a real Greek frappé — the foamy, instant-coffee iced drink invented in Thessaloniki in 1957. Master the shake, foam, and three sweetness levels (sketos, metrios, glykos)."
tags: ["greek frappe", "frappe coffee", "iced coffee", "instant coffee", "international coffee", "summer drinks"]
categories: ["recipes"]
...
draft: false
faq:
  - question: "What is a Greek frappé?"
    answer: "A Greek frappé is a cold, foamy coffee drink made by shaking or whisking instant coffee (traditionally Nescafé Classic), cold water, and sugar until a thick, stable foam forms. It's served over ice with optional evaporated or whole milk and sipped slowly through a straw — often for an hour or two while sitting at a café. Despite using instant coffee, the texture is creamy and the flavor is robust, slightly bitter, and refreshing. The frappé is the unofficial national coffee of Greece."
  - question: "Who invented the Greek frappé?"
    answer: "The Greek frappé was invented by accident in 1957 by Dimitrios Vakondios, a Nestlé sales representative attending the Thessaloniki International Trade Fair. During a coffee break he couldn't find hot water for his Nescafé, so he mixed instant coffee with cold water in a shaker and shook it vigorously. The resulting foamy drink became an instant hit and spread across Greece in the 1960s. It is now one of the country's most recognizable cultural symbols."
  - question: "What's the difference between a frappé and a frappuccino?"
    answer: "A Greek frappé is made with instant coffee, cold water, sugar, and foam — no espresso, no blender, and no ice cream. A Starbucks Frappuccino is a blended ice drink, typically made with brewed coffee or espresso, milk, syrup, and crushed ice, all blended together to a slushy consistency. The Greek frappé is shaken (not blended), uses no ice in the shake itself (only in the serving glass), and has a much thinner texture topped with stable foam."
  - question: "Why does Greek frappé need instant coffee specifically?"
    answer: "Instant coffee contains spray-dried coffee particles plus a small amount of foaming agents that create the signature stiff, stable foam when shaken with cold water. Brewed espresso or filter coffee won't foam properly because the soluble compounds are different — you'll get bubbles, but they collapse in seconds. Nescafé Classic (red label) is the traditional choice in Greece, but any standard instant coffee works. Decaf instant coffee also foams perfectly."
  - question: "What are sketos, metrios, and glykos?"
    answer: "These are the three classic Greek frappé sweetness levels. **Sketos** (σκέτος) means plain — no sugar, just coffee. **Metrios** (μέτριος) is medium — typically 1–2 teaspoons of sugar. **Glykos** (γλυκός) is sweet — 3 or more teaspoons of sugar. Order at a Greek café by name: 'metrios me gala' = medium with milk; 'sketos horis gala' = plain without milk. The sugar must be added during the shake, not after — that's how the foam forms properly."
  - question: "Can I make a Greek frappé without a shaker?"
    answer: "Yes. The traditional café method actually uses an electric handheld milk frother (a small whisk-blade mixer) to whip the coffee, sugar, and a small splash of water — about 30–45 seconds — until a thick, almost solid foam forms. Then the foam is poured into a tall glass, ice and cold water are added, and milk is poured on top. A French press (pumped vigorously) or a blender on low (10 seconds) also works. A cocktail shaker is the home shortcut."
  - question: "How much caffeine is in a Greek frappé?"
    answer: "A standard Greek frappé made with 2 teaspoons of Nescafé Classic contains roughly 60–80 mg of caffeine — similar to a single shot of espresso. The caffeine content scales with how much instant coffee you add: a strong double frappé made with 3 teaspoons can hit 100–120 mg. Compared to a brewed cold brew (180–200 mg per 8 oz) it's relatively mild, which is partly why Greeks can sip frappés for hours."
  - question: "What's the difference between Greek frappé and freddo cappuccino?"
    answer: "Both are popular Greek iced coffees but they're very different drinks. The frappé uses instant coffee, cold water, and sugar — shaken into foam. The freddo cappuccino uses fresh espresso shaken with ice, then topped with cold-foamed milk (afrogala). The freddo espresso is just shaken espresso over ice without milk. Frappés are sweeter, more rustic, and nostalgic; freddos are espresso-based and more polished — they took over as the trendy choice in Greece in the 2010s, but the frappé remains iconic."
---
...
| Name | Greek | Sugar (tsp) | Notes |
|---|---|---|---|
| **Sketos** | σκέτος | 0 | Plain, no sugar — strong, bitter, refreshing |
| **Metrios** | μέτριος | 1–2 | Medium — most common order |
| **Glykos** | γλυκός | 3+ | Sweet — closer to dessert |
...
| Method | Time | Foam quality | Notes |
|---|---|---|---|
| **Cocktail shaker** | 30 sec | Excellent | Easiest at home; no special equipment if you have a shaker |
| **Mason jar (sealed lid)** | 45 sec | Excellent | Same as shaker — works with any tall jar |
| **Electric handheld frother** | 30–45 sec | Best (café quality) | Traditional Greek café method |
| **Blender (low speed)** | 10 sec | Good | Risk of over-blending and breaking the foam |
| **Whisk by hand** | 2+ min | Mediocre | Tiring; foam is thinner |
| **French press** | 30 sec pumping | Good | Pump the plunger up and down vigorously |
...
| Drink | Coffee base | Method | Texture | Sweetness |
|---|---|---|---|---|
| **Greek frappé** | Instant coffee | Shaken cold | Foamy iced drink | Sketos / metrios / glykos |
| **Starbucks Frappuccino** | Brewed coffee or crème base | Blended with ice | Slushy, milkshake-like | Always sweet |
| **Freddo espresso** | Fresh espresso | Shaken with ice | Espresso over ice | Sketos default |
| **Freddo cappuccino** | Fresh espresso + cold foam | Shaken espresso + afrogala foam | Layered iced milk drink | Mild sweetness |
| **Vietnamese iced coffee** | Phin-filtered Robusta | Hot drip then iced | Strong + sweet | Always with condensed milk |
| **Thai iced coffee** | Spiced Thai blend | Sock-filter drip | Strong + spiced | Always with condensed milk |
| **Iced Americano** | Espresso + cold water | Stirred | Diluted espresso | Plain by default |

If you want a blended, milkshake-style "frappé" — that's actually a Frappuccino — see our [frappuccino recipe](/recipes/frappuccino-recipe/). For the espresso-based Greek café drinks, the shaken espresso method is closest to a freddo: see our [shaken espresso recipe](/recipes/shaken-espresso-recipe/).
...
Skip the sugar in the shake. Add 1 tablespoon of sweetened condensed milk to the bottom of the glass before adding the foam. Stir before drinking. This is a Greek-Vietnamese hybrid that's not traditional but is excellent — closer in flavor to [Vietnamese iced coffee](/recipes/vietnamese-coffee-recipe/) but with a foamy top.
...
### Sparkling Frappé
Replace the cold water at the top with cold sparkling water. The carbonation lifts the foam and creates a frizzante texture similar to an [espresso tonic](/recipes/espresso-tonic/) — light, summery, and slightly bitter.

### Mocha Frappé
Add 1 teaspoon of unsweetened cocoa powder to the shake along with the instant coffee. Foam forms slightly weaker but the flavor is excellent. For a stronger mocha note use 2 teaspoons of [mocha sauce](/recipes/mocha-sauce-recipe/) instead.
...
A Greek frappé is shaken instant coffee + cold water + sugar — no blender, no espresso, no ice cream. A Starbucks Frappuccino is a blended slushy made with brewed coffee, milk, syrup, and crushed ice. Different drinks despite the similar name. See our [frappuccino recipe](/recipes/frappuccino-recipe/) for the blended-style version.
...
About 60–80 mg for a standard frappé made with 2 teaspoons of Nescafé Classic — similar to a single shot of espresso. A strong double frappé (3 teaspoons) reaches 100–120 mg. Compared to [cold brew](/guides/cold-brew-recipe/) (180–200 mg per 8 oz), a frappé is mild — which is part of why Greeks can sip them all afternoon.
