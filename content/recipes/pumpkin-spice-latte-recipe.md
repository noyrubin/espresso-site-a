---
title: "Pumpkin Spice Latte Recipe: Make the Real Thing at Home"
date: 2026-04-09
description: "Make a homemade pumpkin spice latte that's better than Starbucks — with real pumpkin, fresh espresso, and a from-scratch spice blend. Hot and iced versions included."
tags: ["recipes", "latte", "espresso", "seasonal", "pumpkin spice"]
categories: ["recipes"]
...
1. **Espresso** — the coffee base. Two shots (about 60ml) is standard.
2. **Pumpkin spice sauce** — pumpkin puree + sugar + warm spices (cinnamon, nutmeg, ginger, cloves). This is what gives the drink its body and flavor.
3. **Steamed milk** — creates the latte texture and balances the spice.
...
1. Combine the pumpkin puree, sugar, water, and all the spices in a small saucepan over medium heat.
2. Whisk constantly until the sugar dissolves and the mixture just reaches a simmer (about 3–4 minutes).
3. Remove from heat. Add vanilla extract and stir.
4. Strain through a fine-mesh sieve into a jar to remove any fibrous bits from the pumpkin.
5. Let cool, then refrigerate. The syrup thickens slightly as it cools.
...
1. **Pull your espresso.** Use a medium-dark roast for best results with the spice flavors — lighter roasts can clash with the sweetness. Aim for a 25–30 second extraction with medium-fine grind.
2. **Add the syrup.** Pour 2 tablespoons of pumpkin spice syrup into the bottom of your cup.
3. **Pour the espresso over the syrup.** Stir briefly to combine.
4. **Steam the milk.** Aim for 60–65°C (140–150°F) — not hotter, or the milk turns harsh. For a classic latte texture, steam to a silky microfoam without stiff peaks. (See our [guide to steaming milk for latte art](/guides/how-to-steam-milk-latte-art/) for technique.)
5. **Pour the milk** over the espresso-syrup mixture in a slow, controlled stream.
6. **Top with whipped cream** if desired, and finish with a sprinkle of cinnamon or store-bought pumpkin spice blend.
...
1. Brew your espresso and let it cool for 5 minutes (or brew it directly over a small handful of ice to cool faster).
2. Fill a tall glass with ice.
3. Add the pumpkin spice syrup and stir it in.
4. Pour the cooled espresso over the ice.
5. Top with cold milk — don't stir, let the layers sit for a moment before drinking.
...
**1. Over-sweetening**
The syrup contains sugar. So does whipped cream. So does flavored milk. Taste as you go and use less syrup if you're adding other sweet elements.

**2. Overheating the milk**
Milk steamed above 70°C (160°F) tastes scorched and flat. Stay at 60–65°C. You should be able to hold your hand comfortably on the outside of the pitcher — if it's too hot to touch, you've gone too far.

**3. Using pumpkin pie filling instead of pumpkin puree**
Pumpkin pie filling already contains sugar and spices, which will make your drink unpredictably sweet and spiced. Use pure pumpkin puree — just pumpkin, nothing else.

**4. Skipping the strain**
The fibrous bits in pumpkin puree don't dissolve into the syrup and create an unpleasant texture. Always strain through a fine-mesh sieve.

**5. Weak espresso**
The strong spice flavors need a strong coffee foundation. Two shots of properly extracted espresso is the minimum. If you're using a moka pot, brew it slightly stronger than usual.
...
- [How to Dial In Espresso: Grind Size Guide](/guides/espresso-grind-size-guide/)
- [How to Steam Milk for Latte Art](/guides/how-to-steam-milk-latte-art/)
- [Espresso Troubleshooting: Why Your Shot Tastes Off](/guides/espresso-troubleshooting/)
- [Mocha Recipe: Hot, Iced, and White Chocolate](/recipes/mocha-recipe/)
- [Dirty Chai Latte: The Spiced Espresso Drink](/recipes/dirty-chai-latte-recipe/)
