...
date: 2026-04-06
description: "Make the viral brown sugar shaken espresso at home. Better than Starbucks, costs a fraction of the price. Includes the exact recipe, ratios, and oat milk tips."
tags: ["brown sugar shaken espresso", "shaken espresso", "iced espresso", "espresso recipe", "starbucks copycat"]
categories: ["recipes"]
...
draft: false
faq:
  - question: "What is in a brown sugar shaken espresso?"
    answer: "A brown sugar shaken espresso contains espresso shots, brown sugar syrup (brown sugar + water + cinnamon), ice, and oat milk. All the ingredients are shaken together to create a frothy, chilled drink topped with more oat milk."
  - question: "How do I make brown sugar shaken espresso without an espresso machine?"
    answer: "You can use a moka pot to brew strong coffee, or make extra-strong AeroPress coffee (use 1:5 ratio instead of standard). A Nespresso or Keurig on the strongest setting also works. Avoid using regular drip coffee — it won't have enough intensity to hold up to the ice and milk."
  - question: "What is the exact Starbucks brown sugar shaken espresso recipe?"
    answer: "Starbucks uses 2–3 shots blonde espresso, 2–3 pumps brown sugar syrup, cinnamon sprinkle, ice, shaken, then topped with oat milk. A grande has 3 shots and 3 pumps of syrup. You can replicate this exactly using blonde or light roast espresso beans and homemade brown sugar syrup."
  - question: "Can I make brown sugar shaken espresso hot?"
    answer: "The 'shaken' preparation is specifically designed for a cold drink — shaking with ice creates the froth and dilutes the espresso slightly for balance. For a hot version, you'd essentially make a brown sugar latte: pull your espresso, add brown sugar syrup, and steam your oat milk before combining."
---
...
**Method:**
1. Combine brown sugar, water, and cinnamon in a small saucepan
2. Heat over medium, stirring until sugar is fully dissolved (about 3 minutes)
3. Do NOT boil — you just want to dissolve the sugar
4. Remove from heat and let cool completely
5. Transfer to a jar or squeeze bottle and refrigerate
...
*This drink pairs well with our [iced latte recipe](/recipes/iced-latte-recipe/) and [cortado and flat white recipes](/recipes/cortado-and-flat-white-recipe/) if you want more iced espresso options.*
