---
title: "Coffee Granita Recipe: Italian Espresso Granita at Home"
date: 2026-04-25
description: "Make authentic Italian coffee granita with just espresso, sugar, and a freezer. No special equipment needed — just the fork-scraping technique for perfect icy crystals."
tags: ["coffee granita", "espresso granita", "italian coffee", "coffee dessert", "frozen coffee"]
categories: ["recipes"]
...
- **[Coffee Ice Cream Recipe](/recipes/coffee-ice-cream-recipe/)** — no-churn and churned methods, 6 variations
- **[Tiramisu Recipe](/recipes/tiramisu-recipe/)** — the classic Italian mascarpone and espresso dessert
- **[Espresso Cake Recipe](/recipes/espresso-cake-recipe/)** — layered espresso cake with mocha buttercream
- **[Affogato Recipe](/recipes/affogato-recipe/)** — espresso poured over vanilla ice cream
- **[Espresso Cheesecake Recipe](/recipes/espresso-cheesecake-recipe/)** — baked and no-bake methods

## FAQ

{{< faq >}}
**Q: What is coffee granita?**

A: Coffee granita (granita di caffè) is an Italian semi-frozen dessert made from sweetened espresso. It has a coarse, icy crystal texture achieved by scraping the freezing mixture every 30–45 minutes — giving it a lighter, flakier texture than sorbet or ice cream.

**Q: Do I need an ice cream maker for coffee granita?**

A: No. Granita is made entirely in a shallow freezer-safe dish using only a fork to scrape the ice crystals as they form. It's one of the most equipment-free frozen desserts you can make.

**Q: What kind of coffee should I use for granita?**

A: Espresso gives the most authentic, intense flavor. Strong moka pot coffee is the classic Sicilian approach and works beautifully. Regular drip coffee brewed double-strength also works, though the flavor will be lighter. Avoid cold brew — it lacks the roast intensity granita needs.

**Q: How sweet should coffee granita be?**

A: Traditional Sicilian granita is lightly sweet — about 3–4 tablespoons of sugar per 2 cups of espresso. You can adjust up or down. Sweetness also determines texture: more sugar = softer, slushier crystals; less sugar = harder, crunchier crystals.

**Q: How long does coffee granita keep in the freezer?**

A: Coffee granita keeps for up to 1 week in the freezer. Cover tightly to prevent ice crystals from forming on the surface. If it freezes solid, let it sit at room temperature for 10–15 minutes and scrape with a fork to restore the flaky texture.

**Q: Can I make coffee granita ahead of time?**

A: Yes — it's an ideal make-ahead dessert. Prepare the granita up to 3 days in advance, cover, and freeze. Scrape and fluff with a fork just before serving for the best texture.
...
<script type="application/ld+json">
{
  ...
  "@type": "Recipe",
  "name": "Coffee Granita",
  "description": "Classic Italian espresso granita — sweet, intense frozen coffee crystals served with whipped cream. No ice cream maker needed.",
  ...
  "keywords": "coffee granita, espresso granita, Italian frozen coffee dessert, granita di caffe",
  "recipeIngredient": [
    "2 cups (480ml) hot brewed espresso or strong coffee",
  ...
  "recipeInstructions": [
    {"@type": "HowToStep", "text": "Brew 2 cups of strong espresso. While hot, stir in sugar and salt until dissolved. Add vanilla if using. Taste and adjust sweetness."},
    {"@type": "HowToStep", "text": "Let cool to room temperature, then pour into a shallow freezer-safe dish (9×13-inch baking dish works well)."},
    {"@type": "HowToStep", "text": "Freeze for 45 minutes until ice crystals begin forming around the edges."},
    {"@type": "HowToStep", "text": "Scrape with a fork, dragging from the edges to the center to break up the crystals. Return to freezer."},
    {"@type": "HowToStep", "text": "Repeat scraping every 30–45 minutes for 2.5–3 hours total, until all liquid has crystallized into loose, flaky ice."},
    {"@type": "HowToStep", "text": "Spoon into chilled glasses. Top with whipped cream and serve immediately."}
  ]
}
</script>
