---
title: "Tiger Milk Tea Recipe (Tiger Boba at Home)"
date: 2026-04-17
description: "Make tiger milk tea at home — the viral brown sugar boba drink with stunning caramel tiger stripes. Includes dirty tiger version with espresso."
tags: ["milk tea", "boba", "brown sugar", "tiger milk tea", "recipe"]
categories: ["recipes"]
...
1. Combine ½ cup dark brown sugar and ¼ cup water in a small saucepan over medium heat.
2. Stir until the sugar dissolves, then let it simmer 5–7 minutes until slightly thickened — it should coat the back of a spoon.
...
2. Add the dried tapioca pearls and stir immediately to prevent sticking.
3. Cook per the package instructions — usually 15–20 minutes until soft and chewy all the way through. Cut one open to check: no white center.
4. Drain and rinse with cold water briefly.
5. Toss the hot pearls with 2 tbsp brown sugar syrup in a bowl. Let them sit and absorb the syrup for 5 minutes.
...
1. Spoon 2 tbsp of warm brown sugar syrup into your tall clear glass.
2. Tilt and rotate the glass slowly, letting the syrup coat the inside walls and drip down in streaks. This creates the "tiger stripe" pattern.
3. Add your cooked boba pearls to the bottom of the glass (about ½ cup).
4. Add ice on top of the boba.
...
**To make it:**
1. Build the base tiger milk tea as above.
2. Pull 1 espresso shot and let it cool for 30 seconds (or use 1 oz cold brew concentrate for zero temperature shock).
3. Slowly pour the espresso over the back of a spoon directly onto the milk surface — this keeps the layers distinct for a few minutes.
4. Drink immediately with a wide boba straw to get all three elements in one sip.
...
**Tiger Brown Sugar Latte (Hot Version):**
Warm the milk (don't foam), coat the glass with hot syrup, skip the ice and boba. Pour warm milk in and serve immediately with the syrup dissolving in.

**Vegan Tiger Boba:**
Use oat milk + a plant-based brown sugar syrup (most are vegan anyway). Same process.

**Tiger Matcha:**
Replace the milk with a lightly sweetened matcha mixture. Skip the espresso. Drizzle with the brown sugar syrup for a matcha tiger. See our [iced matcha latte recipe](/recipes/iced-matcha-latte-recipe/) for the matcha prep.

**Tiger Cold Brew:**
Instead of espresso, use 2 oz cold brew concentrate poured over the top. See our [cold brew recipe](/guides/cold-brew-recipe/) if you want to make it from scratch.

**Tiger Latte (Cafe Breve style):**
Use half-and-half instead of whole milk for an ultra-creamy version.
...
{{< faq >}}
**Q: Is tiger milk tea the same as tiger boba?**
A: Yes — tiger milk tea, tiger boba, tiger sugar boba, and brown sugar boba are all names for the same drink. "Tiger sugar" refers to the brand that popularized it; the drink has the brown sugar stripe pattern.

**Q: Does tiger milk tea have caffeine?**
A: The classic version has zero caffeine — there's no tea, no coffee. The "dirty tiger" version (with an espresso shot) has approximately 63mg of caffeine per shot. See our [espresso caffeine guide](/guides/espresso-caffeine/) for the full breakdown.

**Q: Why is it called tiger milk tea if there's no tea in it?**
A: It's named for the visual — the brown sugar stripes look like a tiger's markings. Despite "milk tea" in the name, the original Tiger Sugar drink in Taiwan contains no tea; it's a brown sugar milk boba.

**Q: Can I use instant tapioca instead of dried boba pearls?**
A: Instant tapioca (the kind used for pudding) won't work — the pearls are too small and dissolve differently. You need large-format tapioca pearls specifically for boba, found at Asian grocery stores or online.

**Q: How sweet is tiger milk tea?**
A: Very sweet — the brown sugar syrup is the dominant flavor. If you prefer less sweet, use only 1 tbsp of syrup for coating the glass instead of 2, and don't add extra on top.

**Q: Can I make the boba in advance?**
A: You can cook the boba pearls 2–3 hours ahead and keep them at room temperature in a little syrup. Don't refrigerate — they become hard and gummy. Beyond 4 hours, the texture degrades.

**Q: What's the difference between tiger milk tea and regular bubble tea?**
A: Regular bubble tea is tea-based (typically black or green tea + milk + boba). Tiger milk tea has no tea — it's all about the brown sugar syrup and milk. Tiger milk tea is also visually distinctive with the stripe effect from the syrup coating the glass.
{{< /faq >}}
