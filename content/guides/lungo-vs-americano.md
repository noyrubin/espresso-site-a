---
title: "Lungo vs Americano: What's the Difference?"
date: 2026-04-06
description: "Lungo and Americano are both larger, diluted espresso drinks — but they're made differently and taste different. Here's exactly how to tell them apart and make each one."
tags: ["lungo", "americano", "espresso drinks", "brewing", "beginner"]
categories: ["guides"]
...
draft: false
faq:
  - question: "What is a lungo?"
    answer: "A lungo (Italian for 'long') is an espresso shot pulled with the same coffee dose as a regular espresso but more water — typically a 1:3 or 1:4 ratio versus espresso's 1:2. The extra water runs through the grounds during extraction, making a larger, more bitter shot (usually 50–80ml). Unlike an Americano, a lungo is not diluted after brewing — the water passes through the coffee during the pull."
  - question: "Is lungo stronger than Americano?"
    answer: "Lungo is more bitter and more concentrated than an Americano, but not necessarily stronger in caffeine. A lungo extracts more compounds (including bitter ones) from the grounds because the water passes through during brewing. An Americano uses a standard espresso shot with water added after, so the flavor is softer and the bitterness lower. Total caffeine content is roughly similar."
  - question: "Can I make a lungo in a regular espresso machine?"
    answer: "Yes — just run more water through the portafilter than usual. Instead of stopping at 36g yield (standard double espresso), let it run to 54–72g. The shot will take longer, the crema will dissipate, and the color will be lighter. Some machines have a dedicated lungo button; on manual machines, just stop the pump when you hit your target weight."
  - question: "Which is better, lungo or Americano?"
    answer: "It depends on what you want. If you like a bolder, more intense flavor and don't mind bitterness, lungo works well. If you want a smooth, mellow black coffee experience with more volume and less bitterness, Americano is the better choice. Many coffee shops don't serve lungo at all — Americano is far more common in the US and UK."
---
...
The water-first method is used in some specialty shops. The espresso-first is more common. See our [Americano vs Long Black guide](/guides/americano-vs-long-black/) for a full comparison of these two approaches — the water order difference is actually the defining distinction between an Americano and a long black.

## Lungo vs Americano: Side-by-Side Comparison

| | Lungo | Americano |
|--|-------|-----------|
| Water method | Through grounds during pull | Added to cup after pull |
| Coffee dose | 18g | 18g |
| Espresso yield | 54–72g | 36g (standard) |
| Total volume | 54–72ml | 120–180ml |
| Bitterness | High (more extraction) | Medium |
| Sweetness | Low | Medium |
| Body | Thin | Medium |
| Crema | Dissipated | Present on top |
| Caffeine | Similar to espresso | Similar to espresso |
| Common in | Italy, specialty coffee | US, UK, worldwide |
...
| Drink | Description | Volume |
|-------|-------------|--------|
| Ristretto | Short pull, 1:1 ratio, sweet and intense | ~18ml |
| Espresso (normale) | Standard pull, 1:2 ratio | ~36ml |
| Lungo | Long pull, 1:3–4 ratio, more bitter | ~60ml |
| Americano | Espresso + added hot water | ~150ml |
| Long Black | Water first + espresso, similar to Americano | ~150ml |

See our [ristretto vs espresso guide](/guides/ristretto-vs-espresso/) for how the shorter end compares.
...
- **[Espresso Grind Size Guide](/guides/espresso-grind-size-guide/)** - How grind affects extraction length and flavor
