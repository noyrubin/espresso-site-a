---
title: "How to Make a Cappuccino at Home (The Right Way)"
date: 2026-04-05
description: "Learn how to make a perfect cappuccino at home — the right ratio, steaming technique, and step-by-step method for a café-quality result every time."
tags: ["cappuccino", "milk steaming", "espresso drinks", "home barista", "beginner"]
categories: ["guides"]
...
draft: false
faq:
  - question: "What is the correct ratio for a cappuccino?"
    answer: "A traditional cappuccino is equal thirds: one part espresso, one part steamed milk, one part dense foam — typically 1–2 oz espresso, 1–2 oz steamed milk, and 1–2 oz foam in a 5–6 oz cup. Many modern cappuccinos use a slightly larger milk ratio (closer to a 1:2 espresso-to-milk ratio), but the defining feature is a thick, dry foam layer on top compared to a latte."
  - question: "What's the difference between a cappuccino and a latte?"
    answer: "The main difference is the amount and texture of foam. A cappuccino has a thick, dense foam layer (about 1 cm or more) and uses less milk overall, giving it a stronger espresso flavor. A latte has more steamed milk and only a thin layer of microfoam — it's creamier and milder. A typical latte is 8–12 oz, while a cappuccino is 5–6 oz."
  - question: "Can you make a cappuccino without an espresso machine?"
    answer: "You can make a close approximation. Use a Moka pot or AeroPress for a concentrated coffee (it won't be true espresso but works well). For the foam, a handheld milk frother or French press can create frothed milk, though the texture won't be as silky as steam-wanded microfoam. The result is a 'cappuccino-style' drink — tasty, but noticeably different from café cappuccino."
  - question: "What milk is best for cappuccino?"
    answer: "Whole milk produces the richest, most stable foam and the best flavor. 2% milk also works well with slightly less body. For non-dairy, oat milk (especially barista editions) creates the best foam texture and complementary flavor. Almond and soy milk are more difficult to foam consistently and can taste sour or separate when heated with espresso."
---
...
The shot should be well-extracted — rich, with a reddish-brown crema on top. Avoid under-extracted (sour, watery) or over-extracted (bitter, dark) shots. For help dialing in, see our [espresso grind size guide](/guides/espresso-grind-size-guide/).
...
1. Purge your steam wand with a quick burst to clear any condensation.

2. Submerge the steam wand tip just below the milk surface, angled slightly off-center toward the edge of the pitcher (to create a spinning vortex).

3. Open the steam valve fully. You want to hear a gentle hissing/tearing sound — not a loud, bubbly gurgling.

4. **For a cappuccino:** Keep the tip near the surface longer than for a latte. Introduce more air during the first 5–8 seconds by keeping the tip just at or slightly above the milk surface. This creates the extra foam.

5. Once you've incorporated enough air (the milk volume will visibly increase), lower the tip slightly deeper to spin and heat the milk without adding more foam.

6. Stop when the pitcher is hot to touch — around **140–155°F (60–68°C)**. Don't overheat or the milk tastes flat and scalded.

7. Wipe the steam wand clean immediately, then purge again.
...
For a deeper dive into milk steaming technique, see our [guide to steaming milk for latte art](/guides/how-to-steam-milk-latte-art/).

### Step 4: Assemble the Cappuccino

1. Pour the espresso shot into your preheated cup first.

2. Give the milk pitcher a swirl to integrate the foam and milk slightly.

3. Hold back the foam with a spoon and pour the steamed milk into the espresso, then spoon the foam on top.
...
4. The finished drink should have a distinct, thick foam layer on top — at least 1 cm deep.
...
**Espresso tastes sour:** The shot was under-extracted. Grind finer, increase your dose slightly, or slow down your extraction. See our [espresso troubleshooting guide](/guides/espresso-troubleshooting/) for more.
