...
date: 2026-04-13
description: "Red eye coffee is drip coffee with a shot of espresso — the ultimate caffeine boost. Learn the red eye, black eye, and dead eye variations plus how to make each one perfectly."
tags: ["espresso", "coffee drinks", "recipes", "caffeine"]
categories: ["guides"]
...
1. **More caffeine** — the obvious reason most people order one
2. **Richer flavor** — espresso is concentrated and adds depth, chocolate notes, and intensity
3. **Body** — espresso contributes oils and a fuller mouthfeel to the thinner drip coffee
...
1. Brew a Moka pot (3-cup or 6-cup works well)
2. Use the concentrated output as your "espresso" component
3. Add to 8 oz of drip coffee

### AeroPress Red Eye

The AeroPress can make concentrated coffee similar to espresso if you use a small amount of water and a short brew time.

1. Use 18g coffee, 40ml water (concentrate recipe)
2. Steep for 30 seconds, press fast
3. Add to drip coffee

Learn more about espresso alternatives in our guide to [espresso vs drip coffee](/guides/espresso-vs-drip-coffee/).

### Nespresso Red Eye

Nespresso capsules pull genuine espresso-pressure shots.

1. Pull a standard Nespresso shot (40 ml)
2. Add to a cup of drip or pour over coffee
...
The key difference: an [americano](/guides/americano-vs-long-black/) is espresso diluted with hot water to taste like drip coffee. A red eye is espresso *added to* actual drip coffee — the flavors combine rather than dilute.
...
**Q: How much caffeine is in red eye coffee?**
...
**Q: Is red eye coffee stronger than espresso?**
...
**Q: Can you make red eye coffee without an espresso machine?**
...
If you're building up your home espresso skills, understanding your caffeine sources is part of the journey. Check out our guide to [espresso beans vs. coffee beans](/guides/espresso-beans-vs-coffee-beans/) to understand how bean selection affects flavor and caffeine, or learn [how to make a proper espresso ratio](/guides/espresso-ratio-guide/) to pull the best possible shot for your red eye base.
