---
title: "Coffee Origins: A Guide to Where Coffee Comes From and How Region Shapes Flavor"
date: 2026-04-26
description: "Coffee origins explained: the coffee belt, the world's top growing countries, and how region, altitude, and processing shape flavor. With a country-by-country flavor guide."
tags: ["coffee guide", "coffee beans", "coffee origins", "single origin"]
categories: ["guides"]
...
(For the French branch of the European coffeehouse tradition — coffee arriving in Marseille in 1644, the 1672 first Paris coffee stall by an Armenian named Pascal, the 1686 opening of Café de Procope as Europe's first true coffeehouse modeled on the Istanbul kahvehane, the 18th-century Procope-as-Enlightenment-salon era (Voltaire reportedly drank 40 cups of coffee a day there; Rousseau, Diderot, and Benjamin Franklin were regulars), the 19th-century Belle Époque café culture (Café de la Rotonde, Café des Deux Magots, Café de Flore — Picasso, Hemingway, Sartre at café tables), the Napoleonic 1806-1814 Continental System chicory tradition that survives today in northern French blends and in New Orleans Café du Monde, and the post-WWII arrival of Italian espresso machines that gave us the modern bistro drink list (café crème, café noisette, café allongé) — see our [What Is French Coffee?](/guides/what-is-french-coffee/) guide. France did not invent the espresso shot, but it built one of the world's most exported café aesthetics around it, and the chicory substitution tradition is the only major coffee-adjacent ingredient innovation outside the bean-and-machine line.)
...
- **Vietnam** — overwhelmingly robusta. Bold, bitter, the foundation of [Vietnamese coffee](/recipes/vietnamese-coffee-recipe/).
...
| Roast date | Freshness — see [how long coffee beans last](/guides/how-long-do-coffee-beans-last/) |
...
1. **Plant.** Coffee shrubs take 3–5 years to begin producing cherries. They thrive in shade, at altitude, in tropical climates.
2. **Cherry development.** Coffee fruits start green, ripen through yellow to deep red. A single tree produces ~1–4 kg of cherries per year, yielding maybe 0.5 kg of green beans.
3. **Harvest.** Best-quality coffee is hand-picked at peak ripeness — labor-intensive and one reason specialty coffee costs more. Cheaper coffee is strip-picked (all cherries at once, regardless of ripeness).
4. **Processing.** Washed, natural, or honey (see above). Typically takes 1–3 weeks.
5. **Drying.** Beans dry to 10–12% moisture on raised beds or patios.
6. **Hulling and sorting.** The dried parchment is removed, beans graded by size, density, and defects.
7. **Export.** Green beans ship in 60–70 kg jute or GrainPro bags.
8. **Roasting.** Local or international roasters transform green beans into the dark, aromatic beans you brew.
9. **Brewing.** That's where you come in.
...
1. **Start with Colombia or Honduras** — balanced, sweet, beginner-friendly. Will taste familiar but better.
2. **Try a Brazil natural** — full body, nutty/chocolatey, low acidity. Great for espresso and milk drinks.
3. **Try a Guatemala or Costa Rica** — adds spice, balanced acidity, more complexity.
4. **Try an Ethiopian (washed)** — brightness, florals, completely different category. Best as pour over.
5. **Try an Ethiopian (natural)** — fruit-forward, almost like blueberry juice. Great with no milk.
6. **Try a Sumatra** — earthy, full-bodied, low-acidity. Polarizing but distinctive.
7. **Try a Kenya AA** — winey, blackcurrant, intense acidity. Showpiece coffee.
...
*Want to go deeper? See our guides on [arabica vs robusta](/guides/arabica-vs-robusta/), [light roast vs dark roast](/guides/light-roast-vs-dark-roast/), [how long coffee beans last](/guides/how-long-do-coffee-beans-last/), and [espresso beans vs coffee beans](/guides/espresso-beans-vs-coffee-beans/).*
