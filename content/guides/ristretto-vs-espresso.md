...
faq:
  ...
  - question: "Does ristretto have more caffeine than espresso?"
    answer: "No — ristretto has slightly less caffeine per shot. Because less water passes through the grounds, less caffeine is extracted. However, the caffeine difference is small (maybe 10–15% less). If a drink calls for a 'double ristretto' instead of a 'double espresso', the total caffeine is roughly similar to a single regular espresso."
  - question: "Why do some cafes use ristretto in milk drinks?"
...
|--|----------|-----------|
| Coffee dose | 18g | 18g |
| Liquid yield | 36g (2x dose) | 18g (1x dose) |
| Ratio | 1:2 | 1:1 |
| Shot time | 25–30 seconds | 15–20 seconds |
| Volume | ~36ml | ~18ml |
| Color | Deep brown | Darker, thicker |
...
**Method 3: Grind finer**
Some baristas pull a ristretto by grinding slightly finer than normal to increase resistance, which slows the shot and keeps it at a normal 25-second time but with less water — this is more advanced and harder to control at home. Stick to method 1 for reliability.
...
Lungo tastes more bitter and less sweet than espresso — you're extracting further into the later, harsher phase. Some people prefer it for its larger volume and stronger caffeine punch. See our [lungo vs americano guide](/guides/lungo-vs-americano/) for how they compare.

## Quick Reference: Espresso Shot Sizes

| Shot type | Ratio | Volume | Taste profile |
|-----------|-------|--------|---------------|
| Ristretto | 1:1 | ~18ml | Sweet, intense, low bitterness |
| Espresso (normale) | 1:2 | ~36ml | Balanced: sweet + bitter + acid |
| Lungo | 1:3–4 | ~54–72ml | Bitter, thinner, more caffeine |
| Americano | 1:2 + hot water | ~120–180ml | Diluted espresso, milder |
