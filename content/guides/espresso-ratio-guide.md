---
title: "Espresso Ratio Guide: Dose, Yield, and Time Explained"
date: 2026-04-04
description: "Learn espresso ratios — what they are, why they matter, and how to use dose, yield, and extraction time to dial in consistently delicious espresso at home."
tags: ["espresso ratio", "espresso dose", "dial in espresso", "espresso extraction", "espresso basics"]
categories: ["guides"]
...
faq:
  - question: "What is the standard espresso ratio?"
    answer: "The standard espresso ratio is 1:2 — one gram of ground coffee to two grams of liquid espresso. For a typical double shot with 18g of coffee, you'd target 36g of espresso yield. This is the starting point used by most specialty coffee shops."
  - question: "What is a ristretto ratio?"
    answer: "A ristretto uses a 1:1.5 ratio — for 18g of coffee, you'd pull only 27g of espresso. This produces a shorter, more concentrated shot that is sweeter and more syrupy than a standard shot, with less bitterness."
  - question: "How long should an espresso shot take?"
    answer: "A standard espresso shot targeting a 1:2 ratio should take 25–35 seconds from when the pump starts. If it's faster, your grind is too coarse. If it's slower, your grind is too fine. Time is a signal about grind, not a direct target to chase."
  - question: "Do I need a scale for espresso?"
    answer: "Yes, a scale is highly recommended. Volume measurements are unreliable because espresso crema adds volume inconsistently. Weighing both your dose (ground coffee input) and yield (liquid output) is the only way to achieve consistent, repeatable espresso."
---
...
| Ratio | Name | Dose:Yield | Character |
|-------|------|-----------|-----------|
| 1:1.5 | Ristretto | 18g → 27g | Very concentrated, sweet, syrupy |
| 1:2 | Standard espresso | 18g → 36g | Balanced, full-bodied, classic |
| 1:2.5 | Lungo (mild) | 18g → 45g | Less intense, slightly more bitter |
| 1:3 | Lungo | 18g → 54g | Diluted, lighter, less espresso character |
...
| Taste | Problem | Fix |
|-------|---------|-----|
| Sour, sharp, thin | Under-extracted | Finer grind (keeps ratio, extends time) |
| Bitter, harsh, dry | Over-extracted | Coarser grind (keeps ratio, shortens time) |
| Weak, watery | Too high a ratio | Lower yield (1:1.8 instead of 1:2) |
| Too intense, thick | Too low a ratio | Higher yield (1:2.2 or 1:2.5) |
...
| Dose (g) | 1:1.5 yield | 1:2 yield | 1:2.5 yield |
|----------|------------|-----------|-------------|
| 16g | 24ml | 32ml | 40ml |
| 18g | 27ml | 36ml | 45ml |
| 20g | 30ml | 40ml | 50ml |
...
```
Standard espresso ratio: 1:2
(18g coffee → 36g espresso)

Extraction time target: 25–35 seconds

Too sour? → Grind finer
Too bitter? → Grind coarser
Too weak? → Lower yield (shorter ratio)
Too intense? → Higher yield (longer ratio)

Ristretto: 1:1.5 (sweeter, more concentrated)
