---
title: "Pour Over vs Espresso: Which Brewing Method Is Right for You?"
date: 2026-04-08
description: "Pour over vs espresso — flavor, technique, cost, and effort compared. Plus how French press fits in. Find out which manual or machine brewing method suits your taste and lifestyle."
tags: ["pour over", "espresso", "french press", "brewing methods", "beginner"]
categories: ["guides"]
...
draft: false
faq:
  - question: "Is pour over coffee stronger than espresso?"
    answer: "No — espresso is far more concentrated. A standard espresso shot contains 30–35mg of caffeine per ounce, while pour over is about 10–15mg per ounce. A 12oz pour over has roughly 120–180mg total caffeine; a double espresso has ~120–130mg in just 2oz."
  - question: "Can a pour over maker make espresso?"
    answer: "No. Pour over uses gravity and low pressure, producing a clean, filter-bright cup. Espresso requires 9 bars of pressure from a machine. You can brew strong coffee with a pour over, but it won't have espresso's concentration, crema, or flavor profile."
  - question: "Which is easier — pour over or espresso?"
    answer: "Pour over is easier to learn. You only need to nail the grind size, water temperature, and pour technique. Espresso requires dialing in grind size, dose, tamp pressure, and extraction time simultaneously. Both reward practice, but pour over has a gentler learning curve."
  - question: "Is French press similar to pour over?"
    answer: "Both are manual brewing methods without pressure, but they're different. Pour over uses a paper filter (or fine metal filter) that traps oils, producing a clean, bright cup. French press uses metal mesh immersion, leaving oils in the cup for a fuller, heavier body."
  - question: "Which has more caffeine — pour over or French press?"
    answer: "French press and pour over have similar caffeine per volume (around 10–15mg/oz). French press uses a coarser grind and longer steep (4 minutes), while pour over uses medium-fine grind and takes 3–4 minutes to brew. The difference in caffeine is small — pour over may be slightly higher due to finer grind extraction."
---
...
### Pour Over Technique
1. Heat water to 92–96°C (197–205°F)
2. Rinse paper filter with hot water (removes paper taste, preheats vessel)
3. Add medium-fine coffee (1:15 ratio — e.g., 20g coffee to 300ml water)
4. Bloom: pour twice the weight of water over grounds (40ml for 20g coffee), wait 30–45 seconds
5. Pour remaining water in slow, circular spirals
6. Total brew time: 3–4 minutes
7. Remove dripper, drink immediately
...
2. Add coarse-ground coffee (1:15 ratio)
3. Pour all water at once, stir to saturate
4. Put lid on (plunger up), steep 4 minutes
5. Press plunger slowly and evenly
6. Pour immediately — don't let it sit or it'll over-extract

**Learning curve:** Easy. The main variable is steep time. Hard to go wrong.

### Espresso Technique
1. Grind fresh coffee fine (powder-adjacent consistency)
2. Dose 18–20g into portafilter
3. Distribute evenly (WDT tool helps), tamp with ~30lbs pressure
4. Lock portafilter, start extraction
5. Target 36–40g espresso output in 25–30 seconds
6. Adjust grind if timing is off (finer = slower; coarser = faster)

**Learning curve:** Steep. Grind size, dose, distribution, tamp pressure, and machine temperature all interact. A shot can go wrong in many ways. Most beginners take 1–2 weeks to pull consistently good shots. See our [espresso grind size guide](/guides/espresso-grind-size-guide/) and [troubleshooting guide](/guides/espresso-troubleshooting/) for help.
...
For more brewing comparisons: [moka pot vs espresso](/guides/moka-pot-vs-espresso/), [cold brew vs espresso](/guides/cold-brew-vs-espresso/), [espresso vs drip coffee](/guides/espresso-vs-drip-coffee/).

Ready to start with espresso? See our [beginner's getting started guide](/guides/getting-started/).
