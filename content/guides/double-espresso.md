---
title: "Double Espresso: What It Is, How to Pull One, and When to Use It"
date: 2026-04-15
description: "Everything about the double espresso (doppio): what it is, how it differs from a single shot, how to pull one correctly, and when to use a double vs single."
tags: ["espresso", "double espresso", "doppio", "guides", "espresso basics"]
categories: ["guides"]
...
| Extraction time | 25–35 seconds | 25–35 seconds |
| Caffeine | ~63 mg | ~126 mg |
| Use case | Straight drinking, cortado | Lattes, cappuccinos, most drinks |
...
A double espresso (1:2 ratio) is more concentrated and intense than a lungo. See the [Lungo Coffee Guide](/guides/lungo-coffee/) for a full comparison.

### Double Espresso vs Ristretto

A ristretto is a shorter, more restricted pull — same dose as a double, but only 1:1.5 ratio (27–30g output) in about 20–25 seconds. A ristretto is sweeter, more concentrated, and syrupy compared to a standard double shot. The [Ristretto vs Espresso Guide](/guides/ristretto-vs-espresso/) covers the full comparison.
...
For a detailed breakdown of espresso caffeine content including per-shot data tables, see the [Espresso Caffeine Guide](/guides/espresso-caffeine/).
...
Espresso grind is fine — finer than drip, coarser than Turkish coffee. A correct grind looks slightly finer than table salt. If you're new to dialing in espresso, see the [Espresso Grind Size Guide](/guides/espresso-grind-size-guide/) for how to adjust.
...
| What you taste | What's happening | Fix |
|---|---|---|
| Sour, thin, sharp | Under-extracted | Grind finer / increase dose |
| Bitter, harsh, dry | Over-extracted | Grind coarser / decrease dose |
| Watery, pale | Too fast / channeling | Check distribution, tamp more evenly |
| Balanced, sweet, mild bitterness | Correct extraction | No change needed |
...
**How much caffeine is in a double espresso?**  
A double espresso contains approximately 120–135 mg of caffeine, depending on the bean and roast. Light roasts tend to have slightly more caffeine (~140–160 mg) while dark roasts are slightly lower (~110–130 mg). See the full [Espresso Caffeine Guide](/guides/espresso-caffeine/) for a detailed breakdown.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is a double espresso?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A double espresso (doppio) is two shots of espresso pulled together from a double portafilter basket, using 18–21g of ground coffee and yielding approximately 36–42g (about 2 oz) of liquid. It is the standard espresso shot at most specialty coffee shops."
      }
    },
    {
      "@type": "Question",
      "name": "How much caffeine is in a double espresso?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A double espresso contains approximately 120–135 mg of caffeine, depending on the bean and roast. Light roasts tend to have slightly more caffeine (140–160 mg) while dark roasts are slightly lower (110–130 mg)."
      }
    },
    {
      "@type": "Question",
      "name": "What is the difference between a double espresso and a lungo?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A double espresso uses a 1:2 coffee-to-water ratio (18g coffee → 36g liquid) extracted in 25–35 seconds. A lungo uses the same coffee dose but pulls 3–4x more water over a longer time (40–60 seconds), producing a lighter, more diluted, slightly more bitter cup. A double espresso is more concentrated and intense."
      }
    },
    {
      "@type": "Question",
      "name": "Is a double espresso stronger than a single?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes — a double espresso contains roughly twice the caffeine of a single shot (approximately 126 mg vs 63 mg). The flavor intensity is also higher, though both single and double are concentrated by definition. Most espresso drinks are built on doubles because they are more consistent and provide enough coffee flavor to come through steamed milk."
      }
    },
    {
      "@type": "Question",
      "name": "How do you make a double espresso at home?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Use 18–21g of freshly ground coffee in a double portafilter basket. Tamp evenly at about 30 lbs of pressure. Lock into the espresso machine and pull until you reach 36–42g of liquid output in 25–35 seconds. Adjust the grind finer if the shot runs too fast or coarser if it runs too slow."
      }
    }
  ]
}
...
## Related Guides
- [Espresso Ratio Guide](/guides/espresso-ratio-guide/) — understanding the 1:2 ratio and why it matters
- [Espresso Caffeine Guide](/guides/espresso-caffeine/) — full caffeine breakdown for all espresso types
