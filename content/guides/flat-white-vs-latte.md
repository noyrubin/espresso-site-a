---
title: "Flat White vs Latte: What's Actually Different?"
date: 2026-04-06
description: "Flat white vs latte — what's the real difference? Compare size, milk ratio, foam texture, and taste to understand which milk espresso drink is right for you."
tags: ["flat white", "latte", "milk drinks", "espresso", "comparison"]
categories: ["guides"]
...
draft: false
faq:
  - question: "What is the main difference between a flat white and a latte?"
    answer: "The main differences are size and the espresso-to-milk ratio. A flat white is typically served in a 5–6 oz cup with a stronger espresso flavor, while a latte is 8–12 oz with a milder, milkier taste. Both use similar microfoam, but the flat white has a thinner foam layer and a higher concentration of espresso relative to milk. Some cafés also use ristretto shots in flat whites for a sweeter, more concentrated espresso base."
  - question: "Which is stronger — a flat white or a latte?"
    answer: "A flat white tastes stronger because the espresso-to-milk ratio is higher. A standard flat white uses 2 shots of espresso in a 5–6 oz cup, while a latte typically uses 2 shots in an 8–12 oz cup. The same amount of espresso is diluted by much less milk in the flat white, making the coffee flavor more pronounced. If you want a stronger espresso taste in a milk drink, flat white is the better choice."
  - question: "Can you make a flat white at home?"
    answer: "Yes. You need an espresso machine with a steam wand. Pull a double shot (or ristretto) into a 5–6 oz cup. Steam milk to about 140°F (60°C) with minimal aeration — you want very fine microfoam, much less than you'd create for a latte. Pour over the espresso from about 1–2 inches above the cup. The key is restraint with the milk: a flat white has a very thin microfoam layer, not the thick layer of a cappuccino."
  - question: "Is a flat white the same as a latte in a small cup?"
    answer: "Almost, but not quite. While both are espresso and steamed milk with microfoam, the flat white typically uses a higher espresso-to-milk ratio and a slightly thinner foam layer. Some cafés use ristretto shots (shorter, sweeter extraction) for flat whites, which further distinguishes the flavor. You can't get a true flat white just by ordering a 'small latte' — the technique and ratios are intentionally different."
---
...
For a detailed latte technique guide, see our [how to make a latte guide](/guides/how-to-make-a-latte/).
...
Neither drink is a cappuccino. A [cappuccino](/guides/how-to-make-cappuccino/) has a thick, intentional foam layer that makes up roughly a third of the drink.
...
1. **Prepare your espresso.** Pull a double shot (or ristretto) directly into your 5–6 oz cup. Start the pour now — you want to add milk while the espresso is still hot and fresh.

2. **Steam the milk.** Use about 4 oz of cold milk. Position the steam wand tip just below the surface and keep the aeration phase very short — a second or two, not five. The goal is to heat the milk while incorporating minimal air. Target temperature: 140–150°F (60–65°C). The milk should be glossy and move as a single mass in the pitcher.

3. **Pour immediately.** Hold the pitcher close to the cup (about 1 inch above) and pour steadily. You want the milk to integrate with the espresso rather than sitting on top.
...
For more on milk steaming technique, see our [guide to steaming milk for latte art](/guides/how-to-steam-milk-latte-art/).
...
1. **Pull a double shot** into your cup.

2. **Steam 6–8 oz of milk.** Aerate slightly more than for a flat white — a few seconds to incorporate enough air for that thin microfoam layer. Target 140–150°F.

3. **Pour** from slightly higher (1–2 inches), guiding the milk stream to mix with the espresso first, then tipping the pitcher to release the foam at the end for latte art if you're attempting it.
