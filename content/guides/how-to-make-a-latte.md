---
title: "How to Make a Latte at Home (Better Than the Coffee Shop)"
date: 2026-04-05
description: "Learn how to make a latte at home with an espresso machine. Step-by-step guide covering espresso, milk steaming, latte art basics, and flavor variations."
tags: ["latte", "milk drinks", "espresso", "beginner"]
categories: ["guides"]
...
If your espresso tastes sour, your extraction is too short — try grinding finer. If it tastes bitter and harsh, it's over-extracted — grind coarser. See our [espresso grind size guide](/guides/espresso-grind-size-guide/) for a systematic approach to dialing in.
...
See our dedicated guide on [how to steam milk for latte art](/guides/how-to-steam-milk-latte-art/) for the beginner walkthrough, and [Milk Steaming Techniques](/guides/milk-steaming-techniques/) for the full methodology — the 8-row diagnostic matrix, the 3-phase protocol, and the heart-tulip-rosetta pour progression for getting consistent microfoam every pitcher.
...
| Latte Size | Espresso | Steamed Milk | Foam Layer |
|------------|----------|--------------|------------|
| 8 oz       | 1–2 shots (18–36g) | ~180ml | ~5mm |
| 12 oz      | 2 shots (36g)  | ~280ml | ~5mm |
| 16 oz      | 2–3 shots      | ~380ml | ~5mm |
...
See our full [iced latte recipe](/recipes/iced-latte-recipe/) for more variations and tips.
...
**Over-tamping:** Compressed too hard, and you'll choke your shot (slow, dark extraction). Tamp firmly and evenly — around 15–20kg of pressure — not maximum force. See our [espresso troubleshooting guide](/guides/espresso-troubleshooting/) if your shots are coming out wrong.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What's the difference between a latte and a cappuccino?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A latte has more steamed milk and a thin foam layer (about 5mm), giving it a smooth, creamy texture. A cappuccino uses equal thirds of espresso, steamed milk, and thick foam, making it stronger and airier. A typical 12oz latte has 2 shots in 280ml of milk; a cappuccino is usually served in a smaller 6oz cup with a thick foam layer."
      }
    },
    {
      "@type": "Question",
      "name": "Can I make a latte without an espresso machine?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can approximate a latte with a Moka pot (which brews strong concentrated coffee) and a handheld milk frother. It won't be identical — Moka pot coffee lacks true espresso crema and pressure — but the flavor profile is similar. Use 1–2 Moka pot shots and heat your milk before frothing. A French press can also froth milk by rapidly plunging, though the foam is less stable."
      }
    },
    {
      "@type": "Question",
      "name": "What milk is best for lattes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Whole milk produces the best microfoam and flavor for traditional lattes. For non-dairy options, barista-edition oat milk (Oatly Barista, Minor Figures, Califia Farms Barista) steams the most similarly to whole milk and holds foam well. Avoid regular almond milk, which struggles to foam and can curdle with acidic espresso."
      }
    },
    {
      "@type": "Question",
      "name": "How many shots of espresso in a latte?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Standard lattes use 1 double shot (about 36g of liquid espresso) for 8–12oz drinks. For 16oz lattes, 2 double shots maintain a noticeable espresso flavor against the larger milk volume. Single shots are sometimes used for small 6oz lattes. Most coffee shops default to a double shot regardless of size."
      }
    }
  ]
}
